...
public class StaffOfEnderItem extends Item implements SimpleBatteryItem {
    public final int TELEPORT_COST = 10_000;
    public long old_energy = 0;
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        tryUseEnergy(user.getStackInHand(hand), TELEPORT_COST);
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        ...
        int difference = (int) (getStoredEnergy(itemStack) - old_energy);
        old_energy = getStoredEnergy(itemStack);
